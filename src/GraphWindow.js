                ...
                <div id="playlist_column">
                    {this.state.selectedNode === null ? (
                        <PlaylistEditor 
                            ...
                            player={this.state.selectedTracks.length > 0 ? this.state.player : undefined} tracks={this.state.selectedTracks} deselectTrack={this.deselectTrack} clearTracks={this.clearTracks} playTrack={(track) => this.playTrack(track)} />
                    ) : (
