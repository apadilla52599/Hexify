                    ...
                    return (
                        <ListItem key={i} style={{padding: "0px", margin: "2px 0px 2px 0px"}}>
                                <div style={{display: "flex", alignItems: "center", flexGrow: 1, backgroundColor: "var(--background-color)" }}>
                                    <p onClick={() => props.playTrack(track)} style={{ cursor: "pointer", color: "white", fontFamily: "monospace", fontSize: "15px", width: "100%", marginTop: "3px", marginBottom: "3px" }}>{track.name}</p>
