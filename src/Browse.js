                            ...
                            <div className="grid-item">
                                <div className="hvrbox">
                                    {graph.genres.slice(0,3).map((genre, index) => (
                                        <div className = "genre" style = {{cursor: "pointer",zIndex: "1",borderStyle: "solid",borderColor: "black" ,position: "absolute",marginTop: (20*(index+1) + "px"), marginBottom: "0%", marginLeft: "85%", height: "15px",width: "15px",backgroundColor: this.getColor(genre.key),borderRadius: "50%", }}>
