    ...
    return (
        <div id="playlist_editor">
            ...
            <div style={{display: "flex", height: "calc(100% - 64px - 64px)", justifyContent: "center", flexGrow: 1 }}>
                <TrackList tracks={props.tracks} handleClick={props.deselectTrack} icon="fas fa-times" />
            </div>
            <div style={{display: "flex", height: "64px", justifyContent: "center", alignItems: "center", flexGrow: 1 }}>
                <Button variant="contained" onClick={props.clearTracks} color="default" style = {{backgroundColor: "#c43636", width: "90%", height: "2rem", fontSize: ".75rem"}}>
